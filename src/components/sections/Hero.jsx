...
const Title = styled(motion.h1)`
  ...
  .hi { display: block; font-weight: 600; opacity: 0.9; font-size: clamp(20px, 4.5vw, 32px); }
  .name { display: block; font-weight: 700; letter-spacing: -0.01em; white-space: nowrap; hyphens: none; font-size: clamp(30px, 6.5vw, 44px); }
